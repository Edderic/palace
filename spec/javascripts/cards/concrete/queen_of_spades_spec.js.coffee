describe 'QueenOfSpades Unit', ->
  beforeEach ->
    @queen_of_spades = new App.Models.QueenOfSpades

  it 'num should be "NINE" and suit should be "DIAMONDS"', ->
    expect @queen_of_spades.suit
      .toEqual 'SPADES'
    expect @queen_of_spades.num
      .toEqual 'QUEEN'

  it '#play_on_top_of(used_deck), used_deck being empty, should return true', ->
    used_deck_double = new Backbone.Collection
    expect @queen_of_spades.play_on_top_of used_deck_double
      .toBe true
