describe 'Nine of Hearts Unit', ->
  beforeEach ->
    @nine_of_diamonds = new App.Models.NineOfDiamonds

  it 'num should be "NINE" and suit should be "DIAMONDS"', ->
    expect @nine_of_diamonds.suit
      .toEqual 'DIAMONDS'
    expect @nine_of_diamonds.num
      .toEqual 'NINE'


  # it '#play_on_top_of(used_deck), used_deck being nil should return true', ->
  #   used_deck = ''
  #   expect @nine_of_diamonds.play_on_top_of used_deck_double
  #     .toBe true
