describe 'AceOfSpades Unit', ->
  beforeEach ->
    @ace_of_spades = new App.Models.AceOfSpades

  it 'num should be "ACE" and suit should be "SPADES"', ->
    expect @ace_of_spades.suit
      .toEqual 'SPADES'
    expect @ace_of_spades.num
      .toEqual 'ACE'

  it '#play_on_top_of(used_deck), used_deck being empty, should return true', ->
    used_deck_double = new Backbone.Collection
    expect @ace_of_spades.play_on_top_of used_deck_double
      .toBe true
