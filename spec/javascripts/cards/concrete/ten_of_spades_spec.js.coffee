describe 'TenOfSpades Unit', ->
  beforeEach ->
    @ten_of_spades = new App.Models.TenOfSpades

  it 'num should be "NINE" and suit should be "DIAMONDS"', ->
    expect @ten_of_spades.suit
      .toEqual 'SPADES'
    expect @ten_of_spades.num
      .toEqual 'TEN'

  it '#play_on_top_of(used_deck), used_deck being empty, should return true', ->
    used_deck_double = new Backbone.Collection
    expect @ten_of_spades.play_on_top_of used_deck_double
      .toBe true
