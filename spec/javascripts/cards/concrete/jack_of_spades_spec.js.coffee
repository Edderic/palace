describe 'JackOfSpades Unit', ->
  beforeEach ->
    @jack_of_spades = new App.Models.JackOfSpades

  it 'num should be "NINE" and suit should be "DIAMONDS"', ->
    expect @jack_of_spades.suit
      .toEqual 'SPADES'
    expect @jack_of_spades.num
      .toEqual 'JACK'

  it '#play_on_top_of(used_deck), used_deck being empty, should return true', ->
    used_deck_double = new Backbone.Collection
    expect @jack_of_spades.play_on_top_of used_deck_double
      .toBe true
